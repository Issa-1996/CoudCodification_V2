...
<body>
        ...
        <form action="traitementPolitique.php" method="get">
            <div id="sections">
                <div class="section">
                    ...
                    <div class="section">
                        <!-- <p><strong>Section 2 : Utilisation des données</strong></p> -->
                        <!-- <p>Description de l'utilisation des données...</p> -->
                        <!-- Ajoutez autant de contenu que nécessaire pour cette section -->
                        <!-- <input type="checkbox" id="section2">
                    <label for="section2">Section 2 : Utilisation des données</label> -->
                    </div>
                </div>
    ...
    <script>
        ...
        // Ajouter un écouteur d'événement pour le bouton "J'accepte"
        //acceptButton.addEventListener('click', () => {
        // Enregistrer le consentement de l'utilisateur (vous pouvez ajouter votre propre logique ici)
        // alert("Merci d'avoir accepté notre politique de confidentialité.");
        // });
    </script>
</body>
